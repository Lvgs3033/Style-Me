...
export default function StyleMeApp() {
  ...
  const analyzeImage = async () => {
    ...
    try {
      ...
      if (result.error === "group_photo") {
        setError("Please upload a solo photo for accurate color analysis. Group photos cannot be analyzed properly.")
        return
      }
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-purple-100 dark:from-gray-900 dark:via-purple-900/20 dark:to-pink-900/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-8 relative z-10">
        ...
        >
          ...
          <div className="mt-8">
            <Link href="/beauty-remedies">
              <Button className="bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 animate-in slide-in-from-bottom duration-700 delay-600">
                <Leaf className="mr-2 h-6 w-6" />
                Explore Natural Beauty Remedies
              </Button>
            </Link>
          </div>

          <div className="mt-12">
            <h2 className="text-2xl font-bold text-center mb-8 bg-gradient-to-r from-pink-600 via-purple-600 to-rose-600 bg-clip-text text-transparent">
              Choose Your Analysis Type
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
              <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer border-2 border-purple-200 hover:border-purple-400">
                <CardContent className="p-6 text-center">
                  <div className="mb-4">
                    <div className="w-16 h-16 mx-auto bg-gradient-to-br from-purple-500 to-indigo-500 rounded-full flex items-center justify-center group-hover:animate-pulse">
                      <Shirt className="h-8 w-8 text-white" />
                    </div>
                  </div>
                  <h3 className="text-lg font-semibold mb-2 text-purple-700">Body Type Analysis</h3>
                  <p className="text-sm text-gray-600 mb-4">
                    Get personalized clothing recommendations for your figure
                  </p>
                  <Button
              ...
              <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer border-2 border-amber-200 hover:border-amber-400">
                <CardContent className="p-6 text-center">
                  <div className="mb-4">
                    <div className="w-16 h-16 mx-auto bg-gradient-to-br from-amber-500 to-yellow-500 rounded-full flex items-center justify-center group-hover:animate-pulse">
                      <Gem className="h-8 w-8 text-white" />
                    </div>
                  </div>
                  <h3 className="text-lg font-semibold mb-2 text-amber-700">Jewelry Recommendations</h3>
                  <p className="text-sm text-gray-600 mb-4">Find the perfect metals and gems for your skin tone</p>
                  <Button
                    onClick={() =>
                      window.scrollTo({
              ...
              <Card className="group hover:shadow-xl transition-all duration-300 transform hover:scale-105 cursor-pointer border-2 border-rose-200 hover:border-rose-400">
                <CardContent className="p-6 text-center">
                  <div className="mb-4">
                    <div className="w-16 h-16 mx-auto bg-gradient-to-br from-rose-500 to-pink-500 rounded-full flex items-center justify-center group-hover:animate-pulse">
                      <Sparkles className="h-8 w-8 text-white" />
                    </div>
                  </div>
                  <h3 className="text-lg font-semibold mb-2 text-rose-700">Makeup Guidance</h3>
                  <p className="text-sm text-gray-600 mb-4">Learn makeup techniques and get style tutorials</p>
                  <Button
        ...
        {/* Upload Section */}
        <Card
          className={`max-w-2xl mx-auto mb-8 transition-all duration-1000 delay-300 upload-section ${isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"}`}
        >
          <CardHeader>
                  ...
                  <TabsContent value="clothing" className="space-y-6 mt-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                      ...
                      {analysisResult.clothingRecommendations.denim && (
                        <Card className="shadow-lg hover:shadow-xl transition-all duration-300">
                          <CardHeader className="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:from-indigo-900/20 dark:to-blue-900/20">
